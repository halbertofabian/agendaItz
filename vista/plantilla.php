...
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['vista/css/fonts.min.css']},
			active: function() {
...
<div class="wrapper">
	...
	<!-- Sweet Alert -->
	<script src="vista/js/plugin/sweetalert/sweetalert.min.js"></script>
